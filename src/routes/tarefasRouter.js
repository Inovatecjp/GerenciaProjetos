...
router.post('/usuarios/:id', gerenteProjetoController.getTarefaByUsuario);
router.get('/:tarefaId/usuarios/com-tarefa', gerenteProjetoController.getUsuariosSemTarefa);
router.get('/:tarefaId/usuarios/', gerenteProjetoController.getUsuariosNaTarefa);
...
router.post('/:id/comentarios',AuthMiddleware, projetoUsuarioController.comentarEmTarefa);
